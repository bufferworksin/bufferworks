...
export default function Contact() {
    ...
    return (
        <section ref={containerRef} className="bg-black text-white py-32 px-6 md:px-12 text-center">
            <h2 className="contact-anim text-5xl md:text-8xl font-bold mb-8">Ready to start?</h2>
